accelerate launch \
  ...
  --dataset_config "/teamspace/studios/this_studio/fluxgym/outputs/pogny-lora/dataset.toml" \
  --output_dir "/teamspace/studios/this_studio/fluxgym/outputs/pogny-lora" \
  --output_name pogny-lora \
  ...
  --logging_dir /teamspace/studios/this_studio/fluxgym/Tensorboard