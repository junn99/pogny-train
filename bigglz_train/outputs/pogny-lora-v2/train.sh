accelerate launch \
  ...
  --dataset_config "/teamspace/studios/this_studio/fluxgym/outputs/pogny-lora-v2/dataset.toml" \
  --output_dir "/teamspace/studios/this_studio/fluxgym/outputs/pogny-lora-v2" \
  --output_name pogny-lora-v2 \
  ...
  --logging_dir /teamspace/studios/this_studio/fluxgym/Tensorboard2